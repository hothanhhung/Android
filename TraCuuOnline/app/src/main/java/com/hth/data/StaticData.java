...
public class StaticData {
    ...
    public static ArrayList<MenuLookUpItem> GetMenuLookUpItems(){
        if(menuLookUpItems == null)
        {
            ...
            menuLookUpItems.add(new MenuLookUpItem("Tra Cứu Đầu Số Di Động",R.drawable.phonenumber,"com.hth.tracuuonline.LookUpForViewWithWebViewRequest","", MenuLookUpItemKind.DauSoDiDong));
