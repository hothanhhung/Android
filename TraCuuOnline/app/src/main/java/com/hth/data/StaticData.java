...
public class StaticData {
    ...
    public static ArrayList<MenuLookUpItem> GetMenuLookUpItems(){
        if(menuLookUpItems == null)
        {
            ...
            menuLookUpItems.add(new MenuLookUpItem("Thông Tin Thời Tiết",R.drawable.weather,"com.hth.tracuuonline.LookUpForViewWithWebViewRequest","", MenuLookUpItemKind.DuBaoThoiTiet));
