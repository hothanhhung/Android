...
public class ExpandableProfileListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<ThucHienQuyenItem>> _profileItems;

    public ExpandableProfileListAdapter(Context context, List<String> listDataGroup,
                                 HashMap<String, List<ThucHienQuyenItem>> profileItems) {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        ThucHienQuyenItem thucHienQuyenItem = ((ThucHienQuyenItem) getChild(groupPosition, childPosition));
