...
public class DataAccessor {
    ...
    public static HashMap<String, List<FavoriteSiteItem>> getSuggestionSiteItems(){
        if(suggestionSiteItems ==  null){
            ...
            suggestionVietnameseItems.add(new FavoriteSiteItem("Báo Lao Động", "", "https://laodong.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Báo Đất Việt", "https://m.baodatviet.vn/images/Icon_DVO.ico", "http://baodatviet.vn/"));
            ...
            suggestionVietnameseItems.add(new FavoriteSiteItem("Viettimes", "", "https://m.viettimes.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Việt Báo", "", "https://vietbao.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Một Thế Giới", "", "https://motthegioi.vn/"));
            ...
            suggestionVietnameseItems.add(new FavoriteSiteItem("VTV", "https://vtv1.mediacdn.vn/web_images/vtv76.png", "https://vtv.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Dân Việt", "", "http://m.danviet.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Tiền Phong", "", "https://www.tienphong.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Báo Tin Tức", "https://cdnstatic.baotintuc.vn/Images/icon.gif", "https://baotintuc.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Giáo Dục Việt Nam", "", "https://giaoduc.net.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Giáo Dục Thời Đại", "https://m.giaoducthoidai.vn/favicon.ico", "https://m.giaoducthoidai.vn/"));
            ...
            suggestionVietnameseItems.add(new FavoriteSiteItem("Genk", "https://genk.mediacdn.vn/web_images/genk60.png", "http://m.genk.vn/"));
            ...
            suggestionVietnameseItems.add(new FavoriteSiteItem("CafeBiz", "https://cafebiz.cafebizcdn.vn/mob_images/cafeBiz32.png", "https://m.cafebiz.vn/"));
            suggestionVietnameseItems.add(new FavoriteSiteItem("Nhịp Cầu Đầu Tư", "https://m.nhipcaudautu.vn/Images/favicon.ico", "https://m.nhipcaudautu.vn/"));
