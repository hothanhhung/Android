...
public class YouTubeService {
	//https://www.googleapis.com/youtube/v3/search?part=id%2Csnippet&maxResults=1&q=podEnglish&type=channel&key=AIzaSyBMhBxnjBMMFOeqO_nqw7TyFf0jN07CHKw
	...
	{
		String url_select = "https://www.googleapis.com/youtube/v3/search?type=video&channelId="+getCurrentChannelID()+"&part=snippet,id";//&maxResults=20&q=&order=date&maxResults=20&key=AIzaSyBMhBxnjBMMFOeqO_nqw7TyFf0jN07CHKw";
