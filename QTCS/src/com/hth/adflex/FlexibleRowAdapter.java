...
import com.hth.quatangcuocsong.R;
...
public class FlexibleRowAdapter extends ArrayAdapter<AdFlexData> {
	private Context activity;
    private ArrayList<AdFlexData> data;
    private static LayoutInflater inflater=null;
    public Resources res;

    public FlexibleRowAdapter(Context a, ArrayList<AdFlexData> d, Resources resLocal ) {
        super( a, R.layout.item_adflex_flexible);
        activity = a;
        data=d;
        res = resLocal;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	if(convertView==null)
        {   
    		convertView = inflater.inflate(R.layout.item_adflex_flexible, null);
    	...
    	AdFlexData adFlex = data.get(position);
        ...
        if(adFlex.getDesc().trim() == "")
            tvShortContent.setVisibility(android.view.View.GONE);
        else{
        ...
        if(adFlex.GetFullType().trim() == "")
            tvNoteContent.setVisibility(android.view.View.GONE);
        else{
            tvNoteContent.setVisibility(View.VISIBLE);
            tvNoteContent.setText(adFlex.GetFullType());
        }
		...
		{
            ivImageArticle.setVisibility(android.view.View.GONE);
		}
        return convertView;
    }
